...
- (NSPoint)convertMouseLocationToBacking: (NSPoint)mouseLocation
{
	NSPoint point = [self convertPoint: mouseLocation fromView: nil];
...
- (void)keyDown: (NSEvent *)theEvent
{
   ...
   location = [self convertMouseLocationToBacking: [[self window] mouseLocationOutsideOfEventStream]];
   _iMouseLocX = rint(location.x);
   _iMouseLocY = rint(location.y);
...
- (void)mouseMoved: (NSEvent *)theEvent
{
   ...
   location = [self convertMouseLocationToBacking: [theEvent locationInWindow]];
   __glutModifierMask = [theEvent modifierFlags];
